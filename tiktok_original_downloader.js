...
(function() {
    ...
    container.innerHTML = `
        ...
        <div style="margin-bottom: 10px; padding: 5px; border-radius: 4px; background: #2d3748; font-size: 12px;">
            ...
            <div>Time: <span id="current-time" style="color: #4ade80;">2025-03-19 22:49:34</span></div>
        </div>
    ...
    function getCurrentlyPlayingVideo() {
        try {
            ...
            // For FYP or profile feed - find the video in viewport
    ...
    function createCurrentVideoDownloadText(video) {
        ...
        text += `# Generated on: 2025-03-19 22:49:34\n`;
    ...
    function downloadVideo(video, index) {
        return new Promise((resolve) => {
            try {
                const filename = `${profileUsername}_video_${index + 1}.mp4`;
